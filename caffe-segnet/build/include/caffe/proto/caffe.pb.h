...
class RotateROIPoolingParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.RotateROIPoolingParameter rotate_pooling_param = 123456;
  inline bool has_rotate_pooling_param() const;
  inline void clear_rotate_pooling_param();
  static const int kRotatePoolingParamFieldNumber = 123456;
  inline const ::caffe::RotateROIPoolingParameter& rotate_pooling_param() const;
  inline ::caffe::RotateROIPoolingParameter* mutable_rotate_pooling_param();
  inline ::caffe::RotateROIPoolingParameter* release_rotate_pooling_param();
  inline void set_allocated_rotate_pooling_param(::caffe::RotateROIPoolingParameter* rotate_pooling_param);
 ...
 private:
  ...
  inline void set_has_rotate_pooling_param();
  inline void clear_has_rotate_pooling_param();
  ...
  ::caffe::RotateROIPoolingParameter* rotate_pooling_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class LossParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional float lambda = 6 [default = 1];
  inline bool has_lambda() const;
  inline void clear_lambda();
  static const int kLambdaFieldNumber = 6;
...
class RotateROIPoolingParameter : public ::google::protobuf::Message {
 public:
  RotateROIPoolingParameter();
  virtual ~RotateROIPoolingParameter();

  RotateROIPoolingParameter(const RotateROIPoolingParameter& from);

  inline RotateROIPoolingParameter& operator=(const RotateROIPoolingParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const RotateROIPoolingParameter& default_instance();

  void Swap(RotateROIPoolingParameter* other);

  // implements Message ----------------------------------------------

  RotateROIPoolingParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RotateROIPoolingParameter& from);
  void MergeFrom(const RotateROIPoolingParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.RotateROIPoolingParameter)
 private:
  inline void set_has_pooled_h();
  inline void clear_has_pooled_h();
  inline void set_has_pooled_w();
  ...
  void InitAsDefaultInstance();
  static RotateROIPoolingParameter* default_instance_;
};
// ===================================================================
...
// optional .caffe.RotateROIPoolingParameter rotate_pooling_param = 123456;
inline bool LayerParameter::has_rotate_pooling_param() const {
  return (_has_bits_[1] & 0x80000000u) != 0;
}
inline void LayerParameter::set_has_rotate_pooling_param() {
  _has_bits_[1] |= 0x80000000u;
}
inline void LayerParameter::clear_has_rotate_pooling_param() {
  _has_bits_[1] &= ~0x80000000u;
}
inline void LayerParameter::clear_rotate_pooling_param() {
  if (rotate_pooling_param_ != NULL) rotate_pooling_param_->::caffe::RotateROIPoolingParameter::Clear();
  clear_has_rotate_pooling_param();
}
inline const ::caffe::RotateROIPoolingParameter& LayerParameter::rotate_pooling_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.rotate_pooling_param)
  return rotate_pooling_param_ != NULL ? *rotate_pooling_param_ : *default_instance_->rotate_pooling_param_;
}
inline ::caffe::RotateROIPoolingParameter* LayerParameter::mutable_rotate_pooling_param() {
  set_has_rotate_pooling_param();
  if (rotate_pooling_param_ == NULL) rotate_pooling_param_ = new ::caffe::RotateROIPoolingParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.rotate_pooling_param)
  return rotate_pooling_param_;
}
inline ::caffe::RotateROIPoolingParameter* LayerParameter::release_rotate_pooling_param() {
  clear_has_rotate_pooling_param();
  ::caffe::RotateROIPoolingParameter* temp = rotate_pooling_param_;
  rotate_pooling_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_rotate_pooling_param(::caffe::RotateROIPoolingParameter* rotate_pooling_param) {
  delete rotate_pooling_param_;
  rotate_pooling_param_ = rotate_pooling_param;
  if (rotate_pooling_param) {
    set_has_rotate_pooling_param();
  } else {
    clear_has_rotate_pooling_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.rotate_pooling_param)
}
...
// optional float lambda = 6 [default = 1];
inline bool LossParameter::has_lambda() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void LossParameter::set_has_lambda() {
  _has_bits_[0] |= 0x00000020u;
}
inline void LossParameter::clear_has_lambda() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void LossParameter::clear_lambda() {
  lambda_ = 1;
  clear_has_lambda();
}
inline float LossParameter::lambda() const {
  // @@protoc_insertion_point(field_get:caffe.LossParameter.lambda)
  return lambda_;
}
inline void LossParameter::set_lambda(float value) {
  set_has_lambda();
  lambda_ = value;
  // @@protoc_insertion_point(field_set:caffe.LossParameter.lambda)
}
...
// optional uint32 pooled_h = 1 [default = 0];
inline bool RotateROIPoolingParameter::has_pooled_h() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void RotateROIPoolingParameter::set_has_pooled_h() {
  _has_bits_[0] |= 0x00000001u;
}
inline void RotateROIPoolingParameter::clear_has_pooled_h() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void RotateROIPoolingParameter::clear_pooled_h() {
  pooled_h_ = 0u;
  clear_has_pooled_h();
}
inline ::google::protobuf::uint32 RotateROIPoolingParameter::pooled_h() const {
  // @@protoc_insertion_point(field_get:caffe.RotateROIPoolingParameter.pooled_h)
  return pooled_h_;
}
inline void RotateROIPoolingParameter::set_pooled_h(::google::protobuf::uint32 value) {
  set_has_pooled_h();
  pooled_h_ = value;
  // @@protoc_insertion_point(field_set:caffe.RotateROIPoolingParameter.pooled_h)
}

// optional uint32 pooled_w = 2 [default = 0];
inline bool RotateROIPoolingParameter::has_pooled_w() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void RotateROIPoolingParameter::set_has_pooled_w() {
  _has_bits_[0] |= 0x00000002u;
}
inline void RotateROIPoolingParameter::clear_has_pooled_w() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void RotateROIPoolingParameter::clear_pooled_w() {
  pooled_w_ = 0u;
  clear_has_pooled_w();
}
inline ::google::protobuf::uint32 RotateROIPoolingParameter::pooled_w() const {
  // @@protoc_insertion_point(field_get:caffe.RotateROIPoolingParameter.pooled_w)
  return pooled_w_;
}
inline void RotateROIPoolingParameter::set_pooled_w(::google::protobuf::uint32 value) {
  set_has_pooled_w();
  pooled_w_ = value;
  // @@protoc_insertion_point(field_set:caffe.RotateROIPoolingParameter.pooled_w)
}

// optional float spatial_scale = 3 [default = 1];
inline bool RotateROIPoolingParameter::has_spatial_scale() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void RotateROIPoolingParameter::set_has_spatial_scale() {
  _has_bits_[0] |= 0x00000004u;
}
inline void RotateROIPoolingParameter::clear_has_spatial_scale() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void RotateROIPoolingParameter::clear_spatial_scale() {
  spatial_scale_ = 1;
  clear_has_spatial_scale();
}
inline float RotateROIPoolingParameter::spatial_scale() const {
  // @@protoc_insertion_point(field_get:caffe.RotateROIPoolingParameter.spatial_scale)
  return spatial_scale_;
}
inline void RotateROIPoolingParameter::set_spatial_scale(float value) {
  set_has_spatial_scale();
  spatial_scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.RotateROIPoolingParameter.spatial_scale)
}
