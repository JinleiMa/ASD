...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dense_image_data_param', full_name='caffe.LayerParameter.dense_image_data_param', index=62,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='rotate_pooling_param', full_name='caffe.LayerParameter.rotate_pooling_param', index=63,
      number=123456, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
...
_LOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lambda', full_name='caffe.LossParameter.lambda', index=5,
      number=6, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ROTATEROIPOOLINGPARAMETER = _descriptor.Descriptor(
  name='RotateROIPoolingParameter',
  full_name='caffe.RotateROIPoolingParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pooled_h', full_name='caffe.RotateROIPoolingParameter.pooled_h', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='pooled_w', full_name='caffe.RotateROIPoolingParameter.pooled_w', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='spatial_scale', full_name='caffe.RotateROIPoolingParameter.spatial_scale', index=2,
      number=3, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['rotate_pooling_param'].message_type = _ROTATEROIPOOLINGPARAMETER
...
DESCRIPTOR.message_types_by_name['RotateROIPoolingParameter'] = _ROTATEROIPOOLINGPARAMETER
...
RotateROIPoolingParameter = _reflection.GeneratedProtocolMessageType('RotateROIPoolingParameter', (_message.Message,), dict(
  DESCRIPTOR = _ROTATEROIPOOLINGPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.RotateROIPoolingParameter)
  ))
_sym_db.RegisterMessage(RotateROIPoolingParameter)
